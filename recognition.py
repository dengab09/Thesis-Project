# =============================================================================
# Part 3: Recognition & Performance Validation (Final Unambiguous Fix)
# =============================================================================
#
# Description:
# This script uses a constant UNKNOWN_LABEL to definitively fix all previous
# issues with case-sensitivity during validation. This ensures that checks for
# unknown persons are always consistent and correct.
#
# =============================================================================
...
LBP_POINTS = 24
LBP_RADIUS = 8
# --- DEFINITIVE FIX: Define a single, consistent label for "unknown" ---
...
def recognize_face(face_roi):
    ...
    # Use the UNKNOWN_LABEL constant for consistency
    ...
    while True:
        ...
        if key == ord('s'):
            ...
            if len(faces) > 0:
                ...
                # Format predicted name for user-friendly display (e.g., "unknown" -> "Unknown")
                ...
                if ground_truth_name:
                    # Logic is now simpler and robust because both variables are consistently lowercase
                    ...
                    # Append consistently-cased data for the final report
